-- Reverse of 014_webhook_admin_audit_activity.up.sql: drop the
-- new CHECK constraints and re-add the previous lists. The
-- 013-era constraints are intentionally identical to the ones
-- baked into 013_oauth_admin_audit_activity.up.sql.
