...
export function CreateBoardModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await onSubmit({
      name: boardName.trim(),
      description: editingBoard ? boardDescription : undefined,
      boardId: editingBoard ? boardId : boardId || undefined,
      templateId: !editingBoard && selectedTemplate ? selectedTemplate : undefined,
    });
  };
