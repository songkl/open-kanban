  ...
  return (
    <div className="mt-10">
      <div className="mb-5 flex items-center gap-3">
        ...
        <h2 className="text-xl font-bold text-zinc-800 dark:text-zinc-100">{t('nav.templates')}</h2>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {templates.map((template) => (
          <div
            key={template.id}
            className="group rounded-2xl bg-white p-5 shadow-sm border border-zinc-100 hover:shadow-lg hover:border-zinc-200 dark:border-zinc-700 transition-all duration-300"
          >
            <div className="flex items-center gap-3 mb-3">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="font-semibold text-zinc-800 dark:text-zinc-100 truncate">{template.name}</h3>
              </div>
            </div>
