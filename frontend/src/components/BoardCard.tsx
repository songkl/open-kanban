    ...
    <div className="group rounded-2xl bg-white dark:bg-zinc-700 p-5 shadow-sm border border-zinc-100 dark:border-zinc-700 hover:shadow-xl dark:hover:border-zinc-600 transition-all duration-300">
      ...
      <div className="grid grid-cols-2 gap-2 mb-4">
        ...
        <Link
          ...
          className="flex items-center justify-center gap-1.5 rounded-xl bg-zinc-50 dark:bg-zinc-700 px-3 py-2 text-xs font-medium text-zinc-600 dark:text-zinc-300 border border-zinc-100 dark:border-zinc-700 hover:bg-zinc-100 dark:hover:bg-zinc-600 dark:hover:border-zinc-600 transition-all"
        >
