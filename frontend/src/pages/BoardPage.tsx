  ...
  return (
    <div className="h-screen bg-zinc-100 dark:bg-zinc-900">
      {showWsWarning && wsStatus !== 'connected' && (
        <div style={{ position: 'fixed', zIndex: 9, minWidth: 300, width: 'auto' }} className="mb-4 rounded-lg bg-orange-100 border border-orange-300 px-4 py-3 flex items-center justify-between">
