...
export function ColumnsPage() {
  ...
  const handleNewColumnNameChange = (name: string) => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-zinc-100 to-zinc-50 dark:from-zinc-800 dark:to-zinc-900 p-6">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="flex items-center gap-3">
          {selectedBoard && (
            <div className="flex items-center gap-1 rounded-xl bg-white dark:bg-zinc-700 px-3 py-1.5 shadow-sm border border-zinc-100">
